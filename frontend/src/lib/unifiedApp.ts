...
const features = [
  ...
  {
    slug: "congregation-services",
    title: "Congregation Services",
    href: "/congregation-services",
    category: "Church Mosque Temple Management",
    icon: Workflow,
    summary: "Congregation Services elevated from the Church Mosque Temple Management source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Congregation Services queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Congregation Services", value: "24", note: 'Active' },
  ...
  },
  {
    ...
    href: "/volunteer-scheduling",
    category: "Church Mosque Temple Management",
    icon: Workflow,
    summary: "Volunteer Scheduling elevated from the Church Mosque Temple Management source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Volunteer Scheduling queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Volunteer Scheduling", value: "33", note: 'Active' },
      { label: 'Review', value: "5", note: 'Needs attention' },
      { label: 'Due Soon', value: "4", note: 'Next 14 days' },
    ],
  },
  {
    slug: "donation-programs",
    title: "Donation Programs",
    href: "/donation-programs",
    category: "Church Mosque Temple Management",
    icon: Workflow,
    summary: "Donation Programs elevated from the Church Mosque Temple Management source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Donation Programs queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Donation Programs", value: "42", note: 'Active' },
...
export const featureFamilies = [
  ...
  { name: 'Church Mosque Temple Management', features: ["Congregation Services","Volunteer Scheduling","Donation Programs"] },
