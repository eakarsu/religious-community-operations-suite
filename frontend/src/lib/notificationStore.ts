...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Members alert', detail: 'Members queue needs review.', read: false },
  { id: 'note-2', title: 'Groups approval due', detail: 'Groups exception list needs approval.', read: false },
  { id: 'note-3', title: 'Events updated', detail: 'Events operating queue was refreshed.', read: true },
];
