...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Religious Community Operations Dashboard"
      subtitle="One merged religious community operations view for Members, Groups, Events, Giving, Volunteers, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared religious community operations jobs into one surface. Members, Groups, Events, Giving, Volunteers, Pastoral Care, documents, audit, and AI are presented as platform features.</div>
