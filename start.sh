...
PORT="${PORT:-4740}"
DB_NAME="${PGDATABASE:-religious_community_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Religious Community Operations Suite"
echo "======================================="
echo
...
echo "Starting religious community operations suite frontend on http://localhost:$PORT"
echo "Login: admin@religious-community.local / admin123"
